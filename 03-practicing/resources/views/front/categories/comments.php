        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header p-3">
                    <h5 class="mr-0">{{ trans('main.comment') }}</h5>
                </div>
                ...
                <div class="card-body">
                    <form method="post" id="comment_form" action="{{ url('add/comment?news_id=' . request('id')) }}">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" placeholder="{{ trans('main.name') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="email">{{ trans('main.email') }}</label>
                            <input type="email" id="email" name="email" class="form-control" placeholder="{{ trans('main.email') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="comment">{{ trans('main.write_comment') }}</label>
                            <textarea id="comment" class="form-control" name="comment" rows="4" placeholder="{{ trans('main.write_comment') }}" required></textarea>
                        </div>
                        <button type="submit" class="btn btn-success btn-block">{{ trans('main.add') }}</button>
