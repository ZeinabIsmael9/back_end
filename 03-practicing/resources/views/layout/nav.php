    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <li><a class="nav-link active" href="<?php echo url('/?lang=en'); ?>"><?php echo trans('main.english'); ?></a></li>
          <?php else: ?>
            <li><a class="nav-link active" href="<?php echo url('/?lang=ar'); ?>"><?php echo trans('main.arabic'); ?></a></li>
            <?php endif; ?>
          </li>
      </ul>
