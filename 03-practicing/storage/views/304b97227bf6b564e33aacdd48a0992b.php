<!doctype html>
<?php
// Check if the session has a locale set; if not, set the default to 'en'
...
<html lang="<?php echo $lang; ?>" dir="<?php echo $dir; ?>" data-bs-theme="auto">
  <head>
    <script src="<?php echo url('assets/front') ?>/js/color-modes.js"></script>
    ...
    <?php if ($lang == 'ar'): ?>
        <link rel="stylesheet" href="<?php echo url('assets/front/css/blog-rtl.css') ?>">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.rtl.min.css">
    <?php else: ?>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo url('assets/front/dist/css/blog.min.css') ?>" rel="stylesheet">
    <?php endif; ?>
