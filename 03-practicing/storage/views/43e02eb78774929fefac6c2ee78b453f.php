...
?>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a class="btn btn-primary" href="<?php echo aurl('news/create') ?>"> <i class="fa-solid fa-plus"></i> <?php echo trans('admin.add') ?> </a>
    </div>
        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo aurl('user/show?id='.$new['user_id']) ?>"><?php echo  $news['user_name'] ?? ''  ?></a></td>
                    <td><a href="<?php echo aurl('categories/show?id='.$new['category_id']) ?>"><?php echo  $news['category_name'] ?? ''  ?></a></td>
                    <td><?php echo  image(storage_url($news['image'] ?? ''))  ?></td>
