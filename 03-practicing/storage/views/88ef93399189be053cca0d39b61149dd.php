...
$users = db_paginate($GLOBALS['connect'], 'user', '', 10);

?>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2><?php echo trans('admin.users') ?></h2>
        <a class="btn btn-primary" href="<?php echo aurl('users/create') ?>"> <i class="fa-solid fa-plus"></i><?php echo trans('admin.add') ?> </a>
    </div>
                ...
                <tr>
                    <?php while ($user = mysqli_fetch_assoc($users['query'])): ?>
                        ...
                        <td>
                            ...
                            <?php echo delete_record(aurl('users/delete?id='.$user['id'])) ?>                        </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
        </table>
