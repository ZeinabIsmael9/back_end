        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="<?php echo trans('cat.name') ?>"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="icon" name="icon" placeholder="<?php echo trans('cat.icon') ?>"
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" placeholder="<?php echo trans('cat.description') ?>"
                            class="form-control <?php echo !empty($description) ? 'is-invalid' : 'is-valid'; ?>"
                            value="<?php echo old('description') ?>"> <?php echo $category['description'] ?></textarea>
                    </div>
