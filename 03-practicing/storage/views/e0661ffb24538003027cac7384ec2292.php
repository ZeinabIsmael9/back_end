...
<div class="container">
  <header class="border-bottom lh-1 py-3">
    ...
    <?php set_locale(request('lang')); ?>
      <?php if ($lang == 'ar'): ?>
        <a class="link-secondary" href="javascript:void(0);" onclick="changeLanguage('en');">
          <?php echo trans('main.english'); ?>
        </a>
      <?php else: ?>
        <a class="link-secondary" href="javascript:void(0);" onclick="changeLanguage('ar');">
          <?php echo trans('main.arabic'); ?>
        </a>
      <?php endif; ?>
    </div>
  ...
  <div class="nav-scroller py-1 mb-3 border-bottom">
    ...
    <a class="nav-item nav-link link-body-emphasis <?php echo  empty(request('category_id')) ? 'active' : ''  ?>" href="#"><?php echo  trans('main.home')  ?></a>
    <?php
