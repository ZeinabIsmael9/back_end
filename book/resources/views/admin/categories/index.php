...
$categories = db_paginate($GLOBALS['connect'], 'categories', '', 1);

?>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2><?php echo trans('admin.categories') ?></h2>
        <a class="btn btn-primary" href="<?php echo aurl('categories/create') ?>"> <i class="fa-solid fa-plus"></i><?php echo trans('admin.add') ?> </a>
    </div>
        ...
        <table class="table table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th scope="col"><?php echo  trans('cat.description') ?></th>
                ...
                <tr>
                    <?php while ($category = mysqli_fetch_assoc($categories['query'])): ?>
                        ...
                        <td>
                            ...
                            <?php echo delete_record(aurl('categories/delete?id='.$category['id'])) ?>                        </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
        </table>
