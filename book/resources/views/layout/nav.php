      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <?php if (session('locale') == 'ar'): ?>
            <a class="nav-link active" href="<?php echo url('lang?lang=en'); ?>" onclick="changeLanguage('en');">
              <?php echo trans('main.english'); ?>
            </a>
          <?php else: ?>
            <a class="nav-link active" href="<?php echo url('lang?lang=ar'); ?>" onclick="changeLanguage('ar');">
